...
export default {
    ...
    data: () => ({
        ...
        headers: [
            {text: 'Sunday', value: 'source'},
            {text: 'Monday', value: 'total_calls'},
            {text: 'Tuesday', value: 'percent_value'},
            {text: 'Wednesday', value: 'percent_value'},
            {text: 'Thursday', value: 'new_calls'},
            {text: 'Friday', value: 'repeated_calls'},
            {text: 'Saturday', value: 'avg_duration'}
        ],
